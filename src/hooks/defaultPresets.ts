...
export const DEFAULT_PRESETS: Preset[] = [
  {
    ...
    stack: [
      ...
      makeEntry("color.contrast_brightness", "Contrast / Brightness", { contrast: 1.2, brightness: -0.05 }),
    ],
  },
  {
    ...
    stack: [
      makeEntry("dithering.palette_dither", "Palette Dither", {
        scale: 1.0, angle: 0, palette_size: 4, amount: 1.0,
        palette_0: [255, 0, 128], palette_1: [0, 255, 255],
        palette_2: [255, 255, 0], palette_3: [0, 0, 0],
        palette_4: [0, 0, 0], palette_5: [0, 0, 0],
        palette_6: [0, 0, 0], palette_7: [0, 0, 0],
      }),
      makeEntry("color.lift_gamma_gain", "Lift / Gamma / Gain", {
        lift_r: 0.1, lift_g: 0.0, lift_b: 0.15,
        gamma_r: 0.0, gamma_g: 0.05, gamma_b: -0.1,
        gain_r: 0.2, gain_g: 0.0, gain_b: 0.3,
        amount: 0.8,
      }),
  ...
  },
  {
    ...
    stack: [
      ...
      makeEntry("color.contrast_brightness", "Contrast / Brightness", { contrast: 1.3, brightness: 0 }),
  ...
  },
  {
    ...
    stack: [
      ...
      makeEntry("color.lift_gamma_gain", "Lift / Gamma / Gain", {
        ...
        gamma_r: 0.0, gamma_g: 0.0, gamma_b: 0.0,
        gain_r: 0.3, gain_g: 0.0, gain_b: 0.2,
        amount: 0.6,
      }),
  ...
  },
  {
    ...
    stack: [
      ...
      makeEntry("color.lift_gamma_gain", "Lift / Gamma / Gain", {
        lift_r: 0.0, lift_g: 0.0, lift_b: 0.0,
        gamma_r: -0.1, gamma_g: 0.0, gamma_b: 0.1,
        gain_r: 0.1, gain_g: 0.2, gain_b: 0.0,
        amount: 0.7,
      }),
