  ...
  return (
    <div ref={ref} className="relative">
      ...
      >
        ...
        <span className="text-dense-xs text-on-surface-variant">{dockedIds.size}/{PANEL_REGISTRY.length}</span>
      </button>
      {open && (
        <div className="absolute right-0 top-full mt-1 z-[200] min-w-[180px] neo-flat rounded-lg bg-surface/90 backdrop-blur-xl border border-outline/20 py-1 shadow-xl">
          <div className="px-3 py-1.5 text-dense-xs font-semibold text-on-surface-variant uppercase tracking-wider border-b border-outline/10">
            Panels
          </div>
