...
export const KeyboardShortcutsEditor: React.FC<KeyboardShortcutsEditorProps> = ({ onClose }) => {
  const [selectedPreset, setSelectedPreset] = React.useState(getPreset());
  const [bindings, setBindings] = React.useState<Record<string, string>>(getAllBindings());
